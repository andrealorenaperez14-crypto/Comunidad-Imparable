...
:root {
  ...
  --bg-light:  #3A2254;
  --gold:      #C17D1A;
  --gold-dim:  rgba(193,125,26,0.12);
  --gold-mid:  rgba(193,125,26,0.35);
  --gold-glow: rgba(193,125,26,0.08);
  --text:      #FAF8F5;
...
.orb-2 { width:350px; height:350px; background:rgba(193,125,26,0.06); bottom:0; right:-5%; }
...
.logo-infinity-wrap::before {
  ...
  border-radius: 50%; border: 1px solid rgba(193,125,26,0.15);
}
...
.nunca-title { font-family:'Montserrat',sans-serif; font-size:0.65rem; letter-spacing:0.25em; text-transform:uppercase; color:rgba(193,125,26,0.5); margin-top:3rem; margin-bottom:1.5rem; }
.nunca-list { display:flex; flex-direction:column; gap:1rem; }
.nunca-item { padding:1rem 1.5rem; background:rgba(193,125,26,0.04); border-left:2px solid rgba(193,125,26,0.3); font-size:0.92rem; color:var(--text-dim); }
.cta-final { padding:8rem 0; text-align:center; position:relative; overflow:hidden; }
.cta-bg { position:absolute; inset:0; background:radial-gradient(ellipse 60% 70% at 50% 50%,rgba(193,125,26,0.07) 0%,transparent 70%); pointer-events:none; }
.cta-price-block { margin:3rem auto; max-width:480px; padding:2.5rem; border:1px solid var(--gold-mid); border-radius:var(--radius); background:var(--bg-card); box-shadow:0 0 60px rgba(193,125,26,0.08); }
      ...
      <div style="display:none;flex-direction:column;align-items:center;">
        <div class="logo-infinity-wrap">
          <svg class="logo-infinity-svg" viewBox="0 0 100 55" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M50,27.5 C50,15 62,6 73,12 C84,18 84,37 73,43 C62,49 50,40 50,27.5 C50,15 38,6 27,12 C16,18 16,37 27,43 C38,49 50,40 50,27.5 Z" stroke="#C17D1A" stroke-width="3.5" stroke-linecap="round"/>
          </svg>
...
<footer>
  ...
  <p style="margin-top:1.2rem;font-size:0.7rem;color:rgba(250,248,245,0.2);font-family:'Montserrat',sans-serif;letter-spacing:0.08em;">Desarrollado por <a href="https://crm-ia-hazel.vercel.app/" target="_blank" rel="noopener" style="color:rgba(193,125,26,0.35);text-decoration:none;transition:color 0.2s;" onmouseover="this.style.color='rgba(193,125,26,0.7)'" onmouseout="this.style.color='rgba(193,125,26,0.35)'">IA Núcleo Estratégico</a></p>
</footer>
