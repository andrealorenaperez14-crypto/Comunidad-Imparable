    ...
    return (
      <div className="h-[calc(100vh-8rem)] flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="font-semibold text-lg mb-2" style={{ color: 'var(--color-text)' }}>IA Coach no disponible</h2>
          <p className="text-sm" style={{ color: 'var(--color-text-muted)' }}>
            El agente IA Coach no está disponible en este momento. Contacta al administrador.
          </p>
        </div>
      </div>
    )
